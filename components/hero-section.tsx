      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Gebze CNC ve Talaşlı İmalat Uzmanı - Osmanoğlu Endüstriyel
          </h1>
          <p className="text-xl md:text-2xl text-blue-200 mb-8 font-medium">CNC Kesim, Talaşlı İmalat, Freze ve Torna Hizmetleri - Hassas Metal Parça Üretimi</p>
